...
//int& tt;
  ...
  ionize(Particles *_particlesPointer, float _dt,
         ...
         float *_rateCoeff_Ionization) : particlesPointer(_particlesPointer), dt(_dt), state(_state), nR_Dens(_nR_Dens), nZ_Dens(_nZ_Dens), DensGridr(_DensGridr), DensGridz(_DensGridz), ne(_ne),
